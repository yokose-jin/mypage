...
前回の<span class="url">[型で数を作る(自然数編)](https://yokose-jin.github.io/mypage/documents/posts/construstNaturalNumber/)</span>
...
この疑問に答えるため、この記事では一般的に可換モノイドから自然に得られる可換群の構成を行う。
